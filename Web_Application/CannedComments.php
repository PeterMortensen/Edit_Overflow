        ...
        <form
            ...
            <p>For p<u>r</u>eemptive use:
                ...
                <input
                    ...
                    id="X32"
                    class="X32"
                    value="Please respond by [editing (changing) your question/answer](https://XXXX), not here in comments (*** *** *** *** *** ***[without](https://meta.stackexchange.com/a/131011)*** *** *** *** *** *** &quot;Edit:&quot;, &quot;Update:&quot;, or similar - the question/answer should appear as if it was written today). "
                    style="width:830px;"
                    accesskey="R"
            ...
            <p id="CodeOnlyComment">
                ...
                <input
                    ...
                    id="X33"
                    class="X33"
                    value="An explanation would be in order. E.g., what is the idea/gist? From [the Help Center](https://stackoverflow.com/help/promotion): *&quot;...always explain why the solution you're presenting is appropriate and how it works&quot;*. Please respond by [editing (changing) your answer](https://XXXX), not here in comments (*** *** *** *** *** ***[without](https://meta.stackexchange.com/a/131011)*** *** *** *** *** *** &quot;Edit:&quot;, &quot;Update:&quot;, or similar - the answer should appear as if it was written today). "
                    style="width:830px;"
                    accesskey="E"
