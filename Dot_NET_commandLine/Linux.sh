...
# Note: The same build number
wordListExport 31 "SQL" $SQL_FILE 6110000 6720000
...
# Note: The same build number
wordListExport 33 "HTML"  $HTML_FILE   3730000 4110000
...
#
# Note: The same build number
wordListExport 35 "JavaScript"  $JAVASCRIPT_FILE   2850000 3150000
