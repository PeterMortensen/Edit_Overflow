...
#
startOfBuildStep "10" "Updating the HTML word list file on pmortenen.eu (<https://pmortensen.eu/EditOverflow/_Wordlist/EditOverflowList_latest.html>)"
...
eval ${LFTP_COMMAND}  ; evaluateBuildResult 9 $? "copying the HTML word list to the web site"
...
# The mirror command for 'lftp' does not work for single files...
#
startOfBuildStep "11" "Updating the JavaScript word list file on pmortenen.eu (<https://pmortensen.eu/world/EditOverflowList.js>)"
...
export LFTP_COMMAND="lftp -e '${FTP_COMMANDS}' -u ${FTP_USER},${FTP_PASSWORD} ${FTP_SITE_URL}"
eval ${LFTP_COMMAND}  ; evaluateBuildResult 10 $? "copying the word list in JavaScript to the web site"
...
# ###########################################################################
#
startOfBuildStep "12" "Starting web interface regression tests"
...
#
keyboardShortcutConsistencyCheck EditOverflow.php         "Edit Overflow lookup"       13

keyboardShortcutConsistencyCheck Text.php                 "text stuff"                 14

keyboardShortcutConsistencyCheck FixedStrings.php         "fixed string"               15

keyboardShortcutConsistencyCheck EditSummaryFragments.php "edit summary"               16
