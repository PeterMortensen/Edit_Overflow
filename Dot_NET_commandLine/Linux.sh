...
#     5. Opening some web pages and applications for manual operations
#     6. Exporting the word list as HTML
#     7. Starting checking generated HTML
#     8. Exporting the word list as JavaScript
#     9. Start running JavaScript unit tests
#    10. Starting web interface regression tests
#
#    11. Keyboard shortcut consistency check: Edit Overflow lookup
#    12. Keyboard shortcut consistency check: text stuff
#    13. Keyboard shortcut consistency check: fixed string
#    14. Keyboard shortcut consistency check: edit summary
#
#    15. Updating the JavaScript word list file on pmortenen.eu (<https://pmortensen.eu/world/EditOverflowList.js>)
#    16. Updating the HTML word list file on pmortenen.eu (<https://pmortensen.eu/EditOverflow/_Wordlist/EditOverflowList_latest.html>)
#
#    17. HTML validation: Edit Overflow lookup
#    18. HTML validation: Text stuff
#    19. HTML validation: Fixed strings
#    20. HTML validation: Edit summary fragments
#    21. HTML validation: Word list (HTML)
#
#    22. Test for: HTML anchor is not unique
#    23. End of build. All build steps succeeded!!
#
#############################################################################
